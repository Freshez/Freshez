...
import { createVendorProfile } from '../../actions/vendorprofile';
import ReactDOM from 'react-dom';
import Modal from 'react-modal';
import {
  openCreateVendorProfileModal,
  closeCreateVendorProfileModal,
} from '../../actions/modal';
...
const CreateVendorProfile = ({
  ...
  const [createvendorprofilestate, setValue] = React.useState(
    localStorage.getItem('createvendorprofile') || false
  );
  ...
  return (
    <Modal
      isOpen={createVendorProfileModalOpen}
...
export default connect(mapStateToProps, {
  ...
  openCreateVendorProfileModal,
  closeCreateVendorProfileModal,
})(withRouter(CreateVendorProfile));
